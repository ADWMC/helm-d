...
- [rsa-attack-techniques](./rsa-attack-techniques.md) for RSA-specific attacks that use lattice methods (Coppersmith, Boneh-Durfee)
- [symmetric-cipher-attacks](./symmetric-cipher-attacks.md) for LCG state recovery via lattice
- [classical-cipher-analysis](./classical-cipher-analysis.md) when lattice methods apply to classical cipher analysis
