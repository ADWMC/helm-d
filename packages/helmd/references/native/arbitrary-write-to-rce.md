...
- [heap-exploitation](./heap-exploitation.md) — obtaining the arbitrary write via heap attacks
- [format-string-exploitation](./format-string-exploitation.md) — obtaining the arbitrary write via %n
- [stack-overflow-and-rop](./stack-overflow-and-rop.md) — stack-based write primitives
- [binary-protection-bypass](./binary-protection-bypass.md) — which targets are available given protection configuration
- [heap-exploitation IO_FILE_EXPLOITATION.md](./heap-exploitation-io-file-exploitation.md) — deep _IO_FILE structure exploitation
...
See [IO_FILE_EXPLOITATION.md](./heap-exploitation-io-file-exploitation.md) for full details.
...
See [kernel-exploitation](./kernel-exploitation.md) for kernel write primitives.
