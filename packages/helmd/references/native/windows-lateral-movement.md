...
- [windows-privilege-escalation](./windows-privilege-escalation.md) after landing on a new host for local escalation
- [windows-av-evasion](./windows-av-evasion.md) when EDR blocks lateral movement tools
- [active-directory-kerberos-attacks](./active-directory-kerberos-attacks.md) for Kerberos-based lateral (pass-the-ticket, delegation)
- [active-directory-acl-abuse](./active-directory-acl-abuse.md) for ACL-based paths to new hosts

### Advanced Reference

Also load [CREDENTIAL_DUMPING.md](./windows-lateral-movement-credential-dumping.md) when you need:
