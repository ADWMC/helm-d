# AV/EDR Evasion — Expert Attack Playbook

## 0. RELATED ROUTING

Before going deep, consider loading:

- [windows-privilege-escalation](./windows-privilege-escalation.md) when privesc tools are blocked by AV
- [windows-lateral-movement](./windows-lateral-movement.md) when lateral movement tools trigger EDR
- [active-directory-kerberos-attacks](./active-directory-kerberos-attacks.md) when Rubeus/Mimikatz are detected
- [active-directory-acl-abuse](./active-directory-acl-abuse.md) for non-binary AD attacks (less AV-sensitive)

### Advanced Reference

Also load [AMSI_BYPASS_TECHNIQUES.md](./windows-av-evasion-amsi-bypass-techniques.md) when you need:
