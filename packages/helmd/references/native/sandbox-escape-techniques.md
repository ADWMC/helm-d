...
- [browser-exploitation-v8](./browser-exploitation-v8.md) — V8 exploitation for renderer RCE before browser sandbox escape
- [container-escape-techniques](./container-escape-techniques.md) — Docker/container specific escape techniques
- [kernel-exploitation](./kernel-exploitation.md) — kernel exploit for container/namespace escape
- [linux-privilege-escalation](./linux-privilege-escalation.md) — post-escape privilege escalation

### Advanced References

- [PYTHON_SANDBOX_ESCAPE.md](./sandbox-escape-techniques-python-sandbox-escape.md) — Full pyjail methodology: `__builtins__` recovery, keyword bypass, AST bypass, pickle escape
- [SECCOMP_BYPASS.md](./sandbox-escape-techniques-seccomp-bypass.md) — Architecture confusion, io_uring bypass, ptrace bypass, allowed syscall chaining
...
See [PYTHON_SANDBOX_ESCAPE.md](./sandbox-escape-techniques-python-sandbox-escape.md) for full methodology.
