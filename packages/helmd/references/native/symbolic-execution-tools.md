...
- [anti-debugging-techniques](./anti-debugging-techniques.md) when anti-debug checks need to be symbolically bypassed
- [code-obfuscation-deobfuscation](./code-obfuscation-deobfuscation.md) when using symbolic execution for deobfuscation
- [vm-and-bytecode-reverse](./vm-and-bytecode-reverse.md) when applying angr to custom VM challenges

### Advanced Reference

Also load [ANGR_COOKBOOK.md](./symbolic-execution-tools-angr-cookbook.md) when you need:
