...
- [linux-privilege-escalation](./linux-privilege-escalation.md) when you first need root inside the container before attempting escape
- [kubernetes-pentesting](./kubernetes-pentesting.md) for K8s-specific attack paths beyond pod escape
- [linux-security-bypass](./linux-security-bypass.md) when seccomp/AppArmor blocks your escape technique

### Advanced Reference

Also load [DOCKER_ESCAPE_CHAINS.md](./container-escape-techniques-docker-escape-chains.md) when you need:
...
See [kubernetes-pentesting](./kubernetes-pentesting.md) for full K8s attack paths.
