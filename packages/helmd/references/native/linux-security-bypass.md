...
- [linux-privilege-escalation](./linux-privilege-escalation.md) once you've broken out of restrictions and need to escalate
- [container-escape-techniques](./container-escape-techniques.md) when security mechanisms are container-specific (seccomp profiles, AppArmor docker-default)
- [linux-lateral-movement](./linux-lateral-movement.md) after bypassing restrictions for pivoting
- [cmdi-command-injection](../web/command-injection.md) when the restriction is on command execution from a web application context
