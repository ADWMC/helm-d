...
- 可在 IDA headless 模式下运行（IDA headless + idalib（禁止 idat -A））
...
项目内置 IDA 调试器脱壳脚本：`scripts/debug_dump.py`

```bash
IDA_OEP_ADDR=0x401000 IDA_OUTPUT="task-dir/unpacked.exe" \
