...
- [lattice-crypto-attacks](./lattice-crypto-attacks.md) for deep lattice theory behind Coppersmith/Boneh-Durfee
- [hash-attack-techniques](./hash-attack-techniques.md) when RSA signature forgery involves hash weaknesses
- [symmetric-cipher-attacks](./symmetric-cipher-attacks.md) when RSA protects a symmetric key (hybrid encryption)

### Advanced Reference

Also load [RSA_ATTACK_CATALOG.md](./rsa-attack-techniques-rsa-attack-catalog.md) when you need:
...
**Use SageMath implementation** — see [lattice-crypto-attacks](./lattice-crypto-attacks.md) for theory.
