...
- [symmetric-cipher-attacks](./symmetric-cipher-attacks.md) when dealing with modern symmetric ciphers (AES/DES) rather than classical
- [hash-attack-techniques](./hash-attack-techniques.md) when the challenge involves hash-based constructions
- [lattice-crypto-attacks](./lattice-crypto-attacks.md) when knapsack-based ciphers are encountered
...
See [symmetric-cipher-attacks](./symmetric-cipher-attacks.md) Section 4.2 for full implementation.
