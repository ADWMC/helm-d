# Windows Local Privilege Escalation — Expert Attack Playbook

## 0. RELATED ROUTING

Before going deep, consider loading:

- [windows-lateral-movement](./windows-lateral-movement.md) after escalation for pivoting to other hosts
- [windows-av-evasion](./windows-av-evasion.md) when AV/EDR blocks your privesc tools
- [active-directory-kerberos-attacks](./active-directory-kerberos-attacks.md) when the host is domain-joined and you need AD-level escalation
- [active-directory-acl-abuse](./active-directory-acl-abuse.md) for domain privilege escalation via ACL misconfigurations

### Advanced Reference

Also load [TOKEN_POTATO_TRICKS.md](./windows-privilege-escalation-token-potato-tricks.md) when you need:
...
Also load [UAC_BYPASS_METHODS.md](./windows-privilege-escalation-uac-bypass-methods.md) when you need:
