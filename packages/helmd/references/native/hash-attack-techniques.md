...
- [rsa-attack-techniques](./rsa-attack-techniques.md) when hash weaknesses affect RSA signature schemes
- [symmetric-cipher-attacks](./symmetric-cipher-attacks.md) when hash is used in key derivation
- [classical-cipher-analysis](./classical-cipher-analysis.md) when analyzing hash-like constructions in classical ciphers
