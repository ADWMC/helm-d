...
- [active-directory-acl-abuse](./active-directory-acl-abuse.md) for ACL-based attacks that enable ESC4 (template modification)
- [active-directory-kerberos-attacks](./active-directory-kerberos-attacks.md) for Kerberos techniques after obtaining certificates
- [ntlm-relay-coercion](./ntlm-relay-coercion.md) for ESC8 (relay to HTTP enrollment endpoint)
- [windows-lateral-movement](./windows-lateral-movement.md) for using obtained certificates for lateral movement

### Advanced Reference

Also load [ADCS_ESC_MATRIX.md](./active-directory-certificate-services-adcs-esc-matrix.md) when you need:
