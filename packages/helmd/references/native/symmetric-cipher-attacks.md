# Symmetric Cipher Attacks — Expert Cryptanalysis Playbook

## 0. RELATED ROUTING

- [rsa-attack-techniques](./rsa-attack-techniques.md) when symmetric key is protected by RSA
- [hash-attack-techniques](./hash-attack-techniques.md) when HMAC or hash-based authentication is involved
- [lattice-crypto-attacks](./lattice-crypto-attacks.md) for LCG/LFSR state recovery via lattice methods

### Advanced Reference

Also load [BLOCK_CIPHER_ATTACKS.md](./symmetric-cipher-attacks-block-cipher-attacks.md) when you need:
