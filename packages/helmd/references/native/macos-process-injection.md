...
- [macos-security-bypass](./macos-security-bypass.md) when you need to bypass TCC, Gatekeeper, or SIP protections blocking your injection
- [linux-privilege-escalation](./linux-privilege-escalation.md) for Unix-layer escalation (shared object hijacking concepts apply)

### Advanced Reference

Also load [DYLIB_XPC_TECHNIQUES.md](./macos-process-injection-dylib-xpc-techniques.md) when you need:
