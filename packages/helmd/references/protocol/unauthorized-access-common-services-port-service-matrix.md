...
- [injection-checking](../web/injection-checking.md) for input-based attacks
- [auth-sec](../web/auth-sec.md) for authentication testing
- [file-access-vuln](../web/file-access-vuln.md) for file operations
- [recon-and-methodology](../web/recon-and-methodology.md) for web reconnaissance
...
See [active-directory-kerberos-attacks](../native/active-directory-kerberos-attacks.md) for full Kerberos attack playbook.
