...
- [tunneling-and-pivoting](./tunneling-and-pivoting.md) after shell access for network pivoting
- [linux-privilege-escalation](../native/linux-privilege-escalation.md) or [windows-privilege-escalation](../native/windows-privilege-escalation.md) after landing shell
- [windows-av-evasion](../native/windows-av-evasion.md) when AV blocks shell payloads

### Quick Reference

Also load [SHELL_CHEATSHEET.md](./reverse-shell-techniques-shell-cheatsheet.md) when you need:
