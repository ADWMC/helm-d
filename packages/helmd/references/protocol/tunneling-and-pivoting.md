...
- [network-protocol-attacks](./network-protocol-attacks.md) for network-level attacks from pivot positions
- [reverse-shell-techniques](./reverse-shell-techniques.md) for establishing initial access shells
- [unauthorized-access-common-services](./unauthorized-access-common-services.md) for exploiting services discovered through pivots
- [linux-privilege-escalation](../native/linux-privilege-escalation.md) or [windows-privilege-escalation](../native/windows-privilege-escalation.md) after pivoting to new hosts
