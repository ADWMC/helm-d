...
- [tunneling-and-pivoting](./tunneling-and-pivoting.md) after establishing MitM position for traffic redirection
- [ntlm-relay-coercion](../native/ntlm-relay-coercion.md) for relaying captured NTLM hashes from poisoning attacks
- [unauthorized-access-common-services](./unauthorized-access-common-services.md) for exploiting services discovered during network attacks
- [traffic-analysis-pcap](../malware/traffic-analysis-pcap.md) for analyzing captured traffic from MitM

### Advanced Reference

Also load [NAME_RESOLUTION_POISONING.md](./network-protocol-attacks-name-resolution-poisoning.md) when you need:
