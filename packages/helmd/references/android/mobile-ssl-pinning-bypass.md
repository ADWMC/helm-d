...
- [android-pentesting-tricks](./android-pentesting-tricks.md) for broader Android testing beyond SSL bypass
- [ios-pentesting-tricks](./ios-pentesting-tricks.md) for broader iOS testing beyond SSL bypass
- [api-sec](../web/api-sec.md) once traffic is intercepted for API-level testing
