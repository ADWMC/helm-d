...
- [llm-prompt-injection](./llm-prompt-injection.md) for LLM-specific prompt injection, jailbreaking, and tool abuse techniques
- [deserialization-insecure](../web/deserialization-insecure.md) for deeper coverage of Python pickle and general deserialization attack patterns
- [dependency-confusion](../protocol/dependency-confusion.md) when the ML pipeline has supply chain risks via pip/npm package confusion
...
For detailed prompt injection techniques, see [llm-prompt-injection](./llm-prompt-injection.md).
...
Covered in [llm-prompt-injection JAILBREAK_PATTERNS.md](./llm-prompt-injection-jailbreak-patterns.md) Section 5.
...
│   ├── Yes → Load [llm-prompt-injection](./llm-prompt-injection.md)
