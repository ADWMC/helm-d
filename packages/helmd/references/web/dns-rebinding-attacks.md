...
- [ssrf-server-side-request-forgery](./ssrf.md) — server-side variant; DNS rebinding is the **client-side** counterpart
- [cors-cross-origin-misconfiguration](./cors-cross-origin-misconfiguration.md) — when CORS misconfig allows direct cross-origin reads instead
