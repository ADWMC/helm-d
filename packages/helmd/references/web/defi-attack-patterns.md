...
- [smart-contract-vulnerabilities](./smart-contract-vulnerabilities.md) for underlying Solidity vulnerability patterns (reentrancy, integer overflow, delegatecall)
- [deserialization-insecure](./deserialization-insecure.md) when targeting off-chain bridge relayer or indexer infrastructure
...
│   └── No → Continue
└── Load [smart-contract-vulnerabilities](./smart-contract-vulnerabilities.md)
