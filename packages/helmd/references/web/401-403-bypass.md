# 401/403 Bypass Techniques — Expert Attack Playbook

## 0. RELATED ROUTING

- [authbypass-authentication-flaws](./authbypass-authentication-flaws.md) — broader auth bypass (login flaws, session handling)
- [waf-bypass-techniques](./waf-bypass-techniques.md) — when bypass is WAF-specific rather than access control
- [http-host-header-attacks](./http-host-header-attacks.md) — Host header manipulation for routing bypass
- [request-smuggling](./request-smuggling.md) — smuggle past access controls entirely
- [http2-specific-attacks](./http2-specific-attacks.md) — h2c smuggling to bypass proxy ACLs
...
# See ../http2-specific-attacks/main document for H2-specific bypasses
```
