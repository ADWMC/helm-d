...
- For GraphQL batching and hidden parameters: [graphql and hidden parameters](./graphql-and-hidden-parameters.md)
- For default credential and brute-force planning: [authentication bypass](./authbypass-authentication-flaws.md)
- For full JWT and OAuth depth: [jwt oauth token attacks](./jwt-attack.md)
- For OAuth or OIDC configuration flaws in browser and SSO flows: [oauth oidc misconfiguration](./oauth-token-attacks.md)
- For credentialed browser reads and origin trust bugs: [cors cross origin misconfiguration](./cors-cross-origin-misconfiguration.md)