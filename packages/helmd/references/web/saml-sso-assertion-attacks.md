...
- XML parser attack depth: [xxe xml external entity](./xxe.md)
- OAuth or OIDC SSO alternatives: [oauth oidc misconfiguration](./oauth-token-attacks.md)
- Auth boundary issues after SSO: [authbypass authentication flaws](./authbypass-authentication-flaws.md)