...
- 方法 A-G 完整绕过代码 → 下文对应 REF 章节
- open_basedir 绕过方法 → 下文对应 REF 章节
- CTF PHP 技巧（OPcache 投毒、多态文件） → 下文对应 REF 章节
