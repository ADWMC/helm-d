...
- Input routing and multi-injection parallel entry -> [Injection Testing Router](./injection-checking.md).
- Template execution chains (non-PP) -> [SSTI](./ssti.md).
- Insecure deserialization (non-JS prototype) -> [Deserialization](./deserialization-insecure.md).
