...
Also see [expression-language-injection](./expression-language-injection.md) for the full OGNL treatment.
...
| `${7*7}` returns 49, Java stack traces | [expression-language-injection](./expression-language-injection.md) |
| `%{7*7}` returns 49, Struts2 errors | [expression-language-injection](./expression-language-injection.md) |
