...
- [prototype-pollution](./prototype-pollution.md) — **LOAD FIRST** for PP fundamentals, merge-sink detection, basic probes
- [ssti-server-side-template-injection](./ssti.md) — template engine RCE context (PP often triggers through template gadgets)
- [xss-cross-site-scripting](./xss.md) — client-side PP gadgets ultimately achieve XSS

### Advanced Reference

Load [KNOWN_GADGETS.md](./prototype-pollution.md) for the comprehensive gadget table by framework/library with polluted properties, trigger conditions, impact, and affected versions.
