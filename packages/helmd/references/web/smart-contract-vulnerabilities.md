...
- [defi-attack-patterns](./defi-attack-patterns.md) when the vulnerability is part of a DeFi protocol exploit (flash loans, oracle manipulation, governance attacks)
- [deserialization-insecure](./deserialization-insecure.md) when the target is off-chain infrastructure deserializing blockchain data

### Advanced Reference

Also load [SOLIDITY_VULN_PATTERNS.md](./smart-contract-vulnerabilities-solidity-vuln-patterns.md) when you need:
...
│   ├── Yes → Load [defi-attack-patterns](./defi-attack-patterns.md)
│   │   ├── Flash loan vectors
│   │   ├── Oracle manipulation
│   │   └── MEV exposure
│   └── No → Continue
