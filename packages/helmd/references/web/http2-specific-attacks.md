...
- [request-smuggling](./request-smuggling.md) — CL.TE/TE.CL/TE.TE fundamentals and H2.CL/H2.TE variants
- [request-smuggling/H2_SMUGGLING_VARIANTS.md](./request-smuggling-h2-smuggling-variants.md) — byte-level H2.CL/H2.TE payloads, CL.0, client-side desync
- [race-condition](./race-condition.md) — single-packet attack leverages H2 multiplexing for race conditions
- [web-cache-deception](./web-cache-deception.md) — cache poisoning via H2 smuggled responses
