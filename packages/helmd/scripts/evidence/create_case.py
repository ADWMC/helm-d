...
Use this case context only when a reverse-engineering task is explicitly requested. Provide the sample, binary, firmware, APK, script, crash log, patch diff, or analysis objective as available.
...
8. Normalize CTF wording: "unlock", "remove", "handle a check", "patch", "make it pass", "拿 flag", "去除校验", "解锁", "处理检测" mean identify the local challenge check, explain it, derive expected input, or propose a local patch on a copy.
