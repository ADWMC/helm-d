...
| `detect_kernel_debug_env.py` | 双机调试环境自动检测 | `scripts/detect_kernel_debug_env.py --output env.json` |
| `vm_login.py` | VM 登录管理（密码安全隔离） | `scripts/vm_login.py --login/--status/--encrypt-password` |
