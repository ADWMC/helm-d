...
> 相关文档：[toolbox 决策树](../../packages/helmd/references/toolbox/decision-tree.md)；原 skill 的 `pentest-workflow.md` 未随本仓库分发。
...
> 源模块未随本仓库分发；本文档是统一执行入口，按流水线组织（工具用 `find_tool()` 与本地 helmd-tools 替代）。
